...
export default function AddCandidatePage({ onBack }: AddCandidatePageProps) {
  const handleSubmit = (data: CandidateFormData) => {
    // eslint-disable-next-line no-console
    console.log('addCandidate submitted', data);
    onBack();
  };
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-semibold text-navy-dark">Add Candidate</h1>
        </div>

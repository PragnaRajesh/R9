...
const SheetOverlay = React.forwardRef<HTMLDivElement, React.ComponentProps<typeof SheetPrimitive.Overlay>>(({ className, ...props }, ref) => (
...
const SheetContent = React.forwardRef<HTMLDivElement, React.ComponentProps<typeof SheetPrimitive.Content> & {
...
const SheetTitle = React.forwardRef<HTMLElement, React.ComponentProps<typeof SheetPrimitive.Title>>(({ className, ...props }, ref) => (
...
const SheetDescription = React.forwardRef<HTMLElement, React.ComponentProps<typeof SheetPrimitive.Description>>(({ className, ...props }, ref) => (
